	...
	public static void main(String[] args) 
	{
		...
		try{
			...
			int a = sc.nextInt();
				...
				{	
					...
					if(a==1)
						System.out.println("줍는다를 선택한 당신은 인생에서 요행을 바라는 사람입니다");
					else if (a==2)
						System.out.println("줍는다를 선택한 당신은 인생에서 요행을 바라지않고 정직하게 사는 사람입니다");
						System.out.println("");	
			}catch(Exception e)
			{
		...
		try{
			...
			int b = sc.nextInt();
				...
				{	
					...
					System.out.println("성의 높이는 이성에게 벽을 세우는 높이를 뜻합니다");
					if (b==1)
						System.out.println("없다를 선택한 당신은 이성을 벽을 세우지않고 잘 지내는 사람입니다");
					else if (b==2)
						System.out.println("1m를 선택한 당신은 이성에게 벽을 세우기는 하지만 높지는 않으므로 이성관계가 나쁘지않습니다");
					else if (b==3)
						System.out.println("2m이상 선택한 당신은 이성에게 높은 벽을 세우는 사람으로 이성관계에 불편함을 느끼고 있을지도 모르겠습니다");
					System.out.println("");
			}catch(Exception e)
			{
				System.out.println("숫자를 입력해야합니다.");
		...
		try{
			...
			String d = sc.next();
						while(true)
					{	
						if(d.equals("창문")||d.equals("옷장") ||d.equals("침대"))
							break;
						else
						System.out.print("다시 적어주세요==> ");
						d = sc.next(); 
					}
			...
			{
				System.out.println("문자를 입력해야합니다.");
				sc.nextLine();
			}
		...
		try{
			...
			int e = sc.nextInt();
				...
				{	
					...
					if (e==1)
						System.out.println("1번을 선택한 당신은 배우자의 외도에도 관계개선을 하려는 사람입니다");
					else if (e==2)
						System.out.println("2번을 선택한 당신은 배우자가 외도를 하면 그대로 관계를 끝내는 사람입니다");
					else if (e==3)
						System.out.println("3번을 선택한 당신은 배우자가 외도를 하면 같이 외도를 하는 사람입니다");
						System.out.println("");
			}catch(Exception e)
			{
				System.out.println("숫자를 입력해야합니다.");
		...
		try {
			...
			System.out.print("1)들어가지 않는다 2)양초를 켠다 3)들어간다==>" );
			int f = sc.nextInt();
				while(true)
				{	
					if(f==1 || f==2 ||f ==3)
					...
					if (f==1)
						System.out.println("1번을 선택한 당신은 죽음을 순순히 받아들이려 하지않는 사람입니다");
					else if (f==2)
						System.out.println("2번을 선택한 당신은 죽음을 순순히 받아들이려 하지않는 사람입니다");
					else if (f==3)
						System.out.println("3번을 선택한 당신은 죽음을 순순히 받아들이는 사람입니다");
			}catch(Exception e)
			{
				System.out.println("숫자를 입력해야합니다.");
				sc.nextLine();
