...
public class MemInfo extends JFrame implements ActionListener {
	...
	public MemInfo()
	{
		...
		btnAdd.addActionListener(this);//ActionListener 인터페이스를 구현한 클래스의 객체
		btnRead.addActionListener(this);//자신이므로 this.
	}
	
	@Override
	public void actionPerformed(ActionEvent e) {
		// TODO Auto-generated method stub
		String cmd = e.getActionCommand();//눌려진 버튼의 글자를 가져온다.
