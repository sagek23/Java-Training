...
public class OrderPanel extends JPanel {
		...
		JComboBox<Integer> cbBnum;
		JComboBox<Integer> cbCnum;
		JTextField tfQuan;
	...
	public OrderPanel() {
		...
		cbBnum = new JComboBox<Integer>(vBnum);
		cbCnum = new JComboBox<Integer>(vCnum);
	...
	protected void addO() {
		// TODO Auto-generated method stub
		rowData.clear();
		//int bnum = (Integer)cbBnum.getSelectedItem();
		int bnum = vBnum.get(cbBnum.getSelectedIndex());
		int cnum = (Integer)cbCnum.getSelectedItem();		
