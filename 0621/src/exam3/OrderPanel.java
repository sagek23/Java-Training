...
public class OrderPanel extends JPanel {
		...
		LinkedHashMap<String, Integer> map = new LinkedHashMap<String, Integer>();//customer용 
		LinkedHashMap<String, Integer> mapb = new LinkedHashMap<String, Integer>();//book용
	...
	public OrderPanel(OrderSearch os) 
	{
		this.os = os;
