...
$(function(){
	...
	$.ajax({url: "http://openapi.seoul.go.kr:8088/784d574a696b736a38357250494a50/xml/GetParkInfo/1/5/",success:function(data){
		...
		$.each(arr, function(idx, item){
			...
			$(p).click(function(){
				var i = $(this).attr("idx");
				var position = arr[i];
				var lat = $(position).find("LAT").text();
				var lng = $(position).find("LNG").text()
